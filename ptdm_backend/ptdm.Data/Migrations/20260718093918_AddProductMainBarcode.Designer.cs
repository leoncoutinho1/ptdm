...
namespace ptdm.Data.Migrations
{
    ...
    [Migration("20260718093918_AddProductMainBarcode")]
    partial class AddProductMainBarcode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ptdm.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ptdm.Domain.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ptdm.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<bool>("IntegrateScale")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("ptdm.Domain.Models.ProductComposition", b =>
                {
                    ...
                    b.HasKey("CompositeProductId", "ComponentProductId");

                    b.HasIndex("ComponentProductId");

                    b.ToTable("product_composition", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ptdm.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ptdm.Domain.Models.ProductComposition", b =>
                {
                    b.HasOne("ptdm.Domain.Models.Product", "ComponentProduct")
                        .WithMany("CompositeProducts")
                        .HasForeignKey("ComponentProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ptdm.Domain.Models.Product", "CompositeProduct")
